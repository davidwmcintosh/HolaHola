...
const SHARED_TABLES = [
  ...
  'emotional_patterns', 'creativity_templates', 'north_star_principles', 'north_star_understanding',
  'north_star_examples', 'daniela_growth_memories', 'daniela_recommendations', 'daniela_beacons',
