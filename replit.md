...
**Immersive Voice & Subtitle System**: The voice chat provides a fully immersive language learning experience with split audio/visual design: (1) TTS voice output speaks ALL content (target language + native language explanations) using the target language voice, giving English words an authentic Spanish accent for natural immersion; (2) On-screen subtitles display ONLY the target language text (Spanish, French, etc.) with English translations removed, reinforcing visual learning of the foreign language; (3) Full conversation history in the History view shows both languages for reference. This dual approach maximizes immersion while maintaining comprehension.
