...
-   **AI Models**: `gpt-4o-mini-realtime-preview-2025-09-25` (for Free/Basic/Institutional tiers) and `gpt-realtime` GA model (August 2025, for Pro tier) for voice chat. The GA model provides 30% better accuracy and 20% cost reduction vs preview versions.