...
import { LayoutDashboard, Users, GraduationCap, FileText, Shield, Mic, Tags, Code, Compass, Map } from "lucide-react";
...
const adminNavItems = [
  ...
  { href: "/admin/journey-memory", label: "Journey Memory", icon: Map },
