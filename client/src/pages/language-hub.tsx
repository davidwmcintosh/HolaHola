...
const FLAG_BG: Record<string, string> = (() => {
  ...
  // Japan — proper bonsai silhouette: wide bumpy canopy, S-curve trunk, side branch, flat pot
  const japanese = _flag(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 200"><g opacity=".15" fill="#3B3B2A"><circle cx="163" cy="74" r="17"/><circle cx="177" cy="63" r="19"/><circle cx="193" cy="56" r="21"/><circle cx="210" cy="54" r="22"/><circle cx="228" cy="58" r="20"/><circle cx="243" cy="68" r="17"/><circle cx="252" cy="78" r="14"/><circle cx="155" cy="82" r="13"/><circle cx="171" cy="50" r="16"/><circle cx="188" cy="42" r="17"/><circle cx="207" cy="40" r="18"/><circle cx="224" cy="44" r="16"/><circle cx="238" cy="54" r="14"/><circle cx="200" cy="30" r="15"/><circle cx="216" cy="32" r="14"/><circle cx="185" cy="34" r="12"/><circle cx="230" cy="40" r="11"/><path d="M192,170 C190,152 185,138 188,124 C191,110 202,104 204,92 C206,80 200,74 203,68 L214,68 C217,74 211,80 213,92 C215,104 226,110 229,124 C232,138 227,152 225,170 Z"/><path d="M225,128 C231,122 239,118 245,116 L246,121 C240,123 233,127 227,133 Z"/><rect x="178" y="176" width="54" height="16" rx="5"/><rect x="172" y="172" width="66" height="7" rx="3"/></g></svg>`);
