...
const FLAG_BG: Record<string, string> = (() => {
  ...
  // Japan — Hinomaru red disc (no white fill so bg-muted shows through cleanly)
  const japanese = _flag(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2"><circle cx="1.5" cy="1" r=".62" fill="#BC002D" opacity=".13"/></svg>`);
