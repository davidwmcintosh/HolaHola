...
const FLAG_BG: Record<string, string> = (() => {
  ...
  // Japan — 2×2 tiled Hinomaru: four discs in the four quadrants, all visible around the white circle
  const japanese = _flag(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 4"><g opacity=".13"><circle cx="1.5" cy="1" r=".62" fill="#BC002D"/><circle cx="4.5" cy="1" r=".62" fill="#BC002D"/><circle cx="1.5" cy="3" r=".62" fill="#BC002D"/><circle cx="4.5" cy="3" r=".62" fill="#BC002D"/></g></svg>`);
