...
const FLAG_BG: Record<string, string> = (() => {
  ...
  // Japan — bonsai silhouette off-centre right; pot at bottom-right, canopy upper-right
  const japanese = _flag(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 200"><g opacity=".11"><rect x="235" y="182" width="38" height="14" rx="3" fill="#8B5E3C"/><rect x="230" y="178" width="48" height="7" rx="2" fill="#8B5E3C"/><path d="M254,178 C251,162 246,145 240,128 C234,111 228,95 230,78" stroke="#6B4226" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M232,100 C238,88 248,74 260,64" stroke="#6B4226" stroke-width="3.5" fill="none" stroke-linecap="round"/><path d="M235,118 C225,108 212,100 198,96" stroke="#6B4226" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M230,82 C232,72 235,62 238,55" stroke="#6B4226" stroke-width="2.5" fill="none" stroke-linecap="round"/><circle cx="258" cy="58" r="14" fill="#2E5E1E"/><circle cx="271" cy="50" r="11" fill="#2E5E1E"/><circle cx="248" cy="50" r="12" fill="#2E5E1E"/><circle cx="278" cy="62" r="10" fill="#2E5E1E"/><circle cx="236" cy="50" r="12" fill="#2E5E1E"/><circle cx="244" cy="42" r="10" fill="#2E5E1E"/><circle cx="196" cy="91" r="13" fill="#2E5E1E"/><circle cx="208" cy="84" r="11" fill="#2E5E1E"/><circle cx="200" cy="76" r="10" fill="#2E5E1E"/></g></svg>`);
