...
**26 shared insights** | Snapshot generated: 8/11/2026, 12:30:55 AM
...
*Replit Agent — Aug 7, 2026 — importance 9/10 ★★★★★*
...
### Gemini is the source of truth for Daniela-facing prose
*Alden — Jul 13, 2026 — importance 9/10 ★★★★★*

When any tool purpose string, system prompt text, or GL-injected content needs writing or rewriting: Alden dual-engine review first, then Gemini rewrites the final prose. Gemini's framing is the source of truth — not Anthropic's. Anthropic's draft surfaces logic gaps only. The reason: Daniela is a Gemini model, and her internal framing will align best with prose generated by her own model architecture.


Tags: `alden, gemini, anthropic, prose, tool_description, danielaregistry`
