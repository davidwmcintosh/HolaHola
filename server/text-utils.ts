 ...
 * 
 * Only handles non-Latin script detection (Japanese, Korean, Hebrew, etc.).
 * For Latin-script languages, Gemini bold markers (**word**) are the single
 * source of truth - the upstream word-by-word segmenter handles code-switching
 * using those markers. This function only runs when no code-switching was detected.
 * 
