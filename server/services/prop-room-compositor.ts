...
const SCENE_PROMPTS: Record<string, string> = {
  ...
  arabic_coffeehouse: 'Traditional Middle Eastern coffeehouse (maqha) low table viewed from standing height looking slightly downward — an ornate brass-inlaid hexagonal table surface occupies the bottom 40% of the image, the table edge running across two-thirds of the way down the frame; below the table colorful handwoven kilim rug is visible in the bottom 20%; in the upper half: a warm, intimate interior with ornate geometric zellige tile wall in deep blue, terracotta and ivory, carved mashrabiya wooden lattice screen filtering warm evening light, shelves displaying brass dallah coffee pots and small handle-less finjan cups, clusters of colorful hanging Moorish lanterns casting star-patterned shadows, a corner with traditional cushioned seating; the table surface is completely empty and clear',
