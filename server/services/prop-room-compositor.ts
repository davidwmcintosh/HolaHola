...
const ENV_VALID_POSITIONS: Record<string, string[]> = {
  ...
  clothing_store:          ['center','left','right','foreground','background','on_floor','on_counter','on_chair'],
  clothing_store_floor:    ['center','left','right','foreground','background','on_floor','on_counter','on_chair'],
  clothing_store_fitting:  ['center','left','right','foreground','background','on_floor','on_chair'],
  clothing_store_checkout: ['center','left','right','foreground','background','on_floor','on_counter'],
  library:          ['center','left','right','foreground','background','on_table','under_table','on_chair','on_floor','on_counter'],
  library_desk:     ['center','left','right','foreground','background','on_table','under_table','on_counter'],
  library_stacks:   ['center','left','right','foreground','background','on_floor','on_chair','on_table'],
  library_checkout: ['center','left','right','foreground','background','on_table','on_counter'],
...
const SCENE_PROMPTS: Record<string, string> = {
  ...
  clothing_store:          'Interior of a stylish clothing boutique — neatly arranged racks of folded and hanging garments in muted tones, a central display table with folded sweaters, full-length mirrors on the walls, a fitting room with a curtain in the background, warm recessed lighting, polished wooden floors',
  clothing_store_floor:    'Inside a stylish clothing boutique browsing area — long racks of hanging garments line the walls and divide the room, a central island table with neatly folded sweaters and accessories, a shop assistant visible in the background, full-length mirrors between racks, warm recessed spotlights, polished wooden floors, a customer browsing the hanging clothes',
  clothing_store_fitting:  'The fitting room corridor of a clothing boutique — a row of curtained changing cubicles with soft warm lighting, a padded bench running along the opposite wall, garment hooks beside each curtain, extra clothing items folded on a shelf, a full-length mirror outside the cubicles, a shop assistant waiting nearby with a smile',
  clothing_store_checkout: 'The checkout counter of a stylish clothing boutique — a sleek wooden counter with a card reader and neat register display, folded tissue paper and branded shopping bags stacked beside it, a lit glass case with accessories alongside the counter, a friendly staff member behind the desk, receipt printer and pen cup visible, a hanging garments rail in the background',
  library:          'Interior of a warm public library — tall dark-wood bookshelves lined with colourful spines stretching to the ceiling, long reading tables with green-shaded lamps, comfortable armchairs in a reading nook near a tall window, a circulation desk with a librarian in the background, soft filtered daylight',
  library_desk:     'The circulation desk at the entrance of a warm public library — a curved wooden desk with a computer terminal and a book-return slot, a staff member standing behind it, brochures and library cards fanned out on the counter, a cork notice board with events pinned behind the desk, tall bookshelves visible through the open space, soft warm overhead lighting',
  library_stacks:   'A quiet aisle between tall library bookshelves — floor-to-ceiling dark-wood shelving units recede into the distance on both sides, colourful book spines packed tightly in rows, a wheeled book trolley parked in the aisle, low track lighting overhead, a small wooden step stool leaning against one shelf, a distant figure browsing at the far end',
  library_checkout: 'The self-service checkout and returns area of a public library — a low counter with a self-checkout machine and barcode scanner, a book-return slot in the side of the desk, a spinning rack of bookmarks and reading accessories, a small handwritten "Returns" sign, a tote bag hanging on a hook, warm ambient library lighting, neat and welcoming',
