...
const DALL_E_STYLE = `Soft watercolor children's book illustration style. Warm, gentle colors with clean fine ink outlines. Wide landscape 16:9 format. At most 2-3 people visible in the entire scene. Every character shown from head to waist with face clearly visible. All characters wear contemporary casual clothing — jeans, T-shirts, blouses, sweaters, blazers, sneakers. Every character's full head and hair are uncovered and clearly visible. No text, letters, numbers, signs, labels, or typography of any kind anywhere in the image. Suitable for a language-learning app scenario card thumbnail.`;
