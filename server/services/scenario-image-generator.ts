...
const SCENE_OVERRIDES: Record<string, string> = {
  ...
  'the-bank': `Modern bank interior. At the extreme left edge of the image: a large leafy potted plant on the floor. At the extreme right edge of the image: a second large potted plant. The entire background wall is a flat cream color. A long low wooden desk spans across the scene: a male bank employee with short natural hair (uncovered, no hat) in a dark dress shirt sits behind it smiling; a female customer with shoulder-length curly hair (uncovered, no hat) stands on the near side holding her phone out toward him. The floor is visible at the bottom. No arched windows, no oval frames, no teller-window shapes anywhere. ${DALL_E_STYLE}`,
