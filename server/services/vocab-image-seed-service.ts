...
export const SCENE_OVERRIDES: Record<string, string> = {
  ...
  'hasta manana':       `${CHAR.ES.primary} and ${CHAR.ES.secondary} waving goodbye to each other at a sunny doorway, a plain blank monthly wall calendar with an empty white grid hanging on the wall beside them, no text no numbers no writing no labels anywhere in the image, warm cheerful watercolor illustration`,
