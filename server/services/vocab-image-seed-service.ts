...
export const SCENE_OVERRIDES: Record<string, string> = {
  ...
  'como esta':          `${CHAR.ES.primary} on a sunny sidewalk warmly greeting an elderly Mexican woman with short silver-streaked hair in a neat bun, warm brown skin, kind dark eyes, and a colorful floral embroidered blouse — the older woman smiling back with gentle affection, a respectful intergenerational exchange between the two`,
