...
export const SCENE_OVERRIDES: Record<string, string> = {
  ...
  'hasta manana':       `${CHAR.ES.primary} waving goodbye to ${CHAR.ES.abuela} outside a cozy house, a plain blank monthly wall calendar with an empty white grid visible on the wall behind them, no text no numbers no writing no labels anywhere in the image, warm cheerful watercolor illustration`,
  ...
  // feliz & triste — standalone (not a SPLIT pair); each gets its own distinct illustration
  'feliz':    'a person with a wide genuine smile, eyes crinkled with joy, arms slightly raised and open, warm golden sunlit background, bright watercolor illustration, flat educational watercolor style, no text',
  'triste':   'a person with a downturned mouth, glistening eyes, and a single tear on one cheek, slightly slumped shoulders, soft cool blue-gray background, bright watercolor illustration, flat educational watercolor style, no text',
  ...
  // ── Emotions — standalone watercolor illustrations of real people (not emoji faces) ─────────
  // Each entry produces one unambiguous emotional portrait in the app's illustrated style.
  'enojado':          'a person with deeply furrowed brows, clenched jaw, and arms tightly crossed, face slightly flushed, warm red-orange tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'enojada':          'a person with deeply furrowed brows, clenched jaw, and arms tightly crossed, face slightly flushed, warm red-orange tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'enfadado':         'a person with deeply furrowed brows, clenched jaw, and arms tightly crossed, face slightly flushed, warm red-orange tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'molesto':          'a person with deeply furrowed brows, clenched jaw, and arms tightly crossed, face slightly flushed, warm red-orange tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'nervioso':         'a person with wide anxious eyes and hunched shoulders, hands fidgeting together at chest, biting their lip with a worried look, pale cool background, bright watercolor illustration, flat educational watercolor style, no text',
  'nerviosa':         'a person with wide anxious eyes and hunched shoulders, hands fidgeting together at chest, biting their lip with a worried look, pale cool background, bright watercolor illustration, flat educational watercolor style, no text',
  'ansioso':          'a person with wide anxious eyes and hunched shoulders, hands fidgeting together at chest, biting their lip with a worried look, pale cool background, bright watercolor illustration, flat educational watercolor style, no text',
  'sorprendido':      'a person with eyebrows raised high, eyes wide open, mouth forming an O, both hands flying up near face in shock, bright clean background, bright watercolor illustration, flat educational watercolor style, no text',
  'sorprendida':      'a person with eyebrows raised high, eyes wide open, mouth forming an O, both hands flying up near face in shock, bright clean background, bright watercolor illustration, flat educational watercolor style, no text',
  'asombrado':        'a person with eyebrows raised high, eyes wide open, mouth forming an O, both hands flying up near face in shock, bright clean background, bright watercolor illustration, flat educational watercolor style, no text',
  'aburrido':         'a person with heavy drooping eyelids and a completely flat expression, chin resting in one hand, slouched, eyes glazing to the side, muted gray-beige background, bright watercolor illustration, flat educational watercolor style, no text',
  'aburrida':         'a person with heavy drooping eyelids and a completely flat expression, chin resting in one hand, slouched, eyes glazing to the side, muted gray-beige background, bright watercolor illustration, flat educational watercolor style, no text',
  'aburrimiento':     'a person with heavy drooping eyelids and a completely flat expression, chin resting in one hand, slouched, eyes glazing to the side, muted gray-beige background, bright watercolor illustration, flat educational watercolor style, no text',
  'asustado':         'a person with wide frightened eyes and eyebrows arched high, shoulders raised in a startled shrug, both hands held up protectively near chest, shadowy cool blue background, bright watercolor illustration, flat educational watercolor style, no text',
  'asustada':         'a person with wide frightened eyes and eyebrows arched high, shoulders raised in a startled shrug, both hands held up protectively near chest, shadowy cool blue background, bright watercolor illustration, flat educational watercolor style, no text',
  'atemorizado':      'a person with wide frightened eyes and eyebrows arched high, shoulders raised in a startled shrug, both hands held up protectively near chest, shadowy cool blue background, bright watercolor illustration, flat educational watercolor style, no text',
  'cansado':          'a person mid-yawn with droopy heavy eyelids, one hand partially covering their open mouth, head slightly drooping, soft deep-blue evening tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'cansada':          'a person mid-yawn with droopy heavy eyelids, one hand partially covering their open mouth, head slightly drooping, soft deep-blue evening tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'agotado':          'a person mid-yawn with droopy heavy eyelids, one hand partially covering their open mouth, head slightly drooping, soft deep-blue evening tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'avergonzado':      'a person with rosy flushed cheeks and eyes looking down and away, shoulders slightly hunched inward, small sheepish grimace, warm soft pink background, bright watercolor illustration, flat educational watercolor style, no text',
  'avergonzada':      'a person with rosy flushed cheeks and eyes looking down and away, shoulders slightly hunched inward, small sheepish grimace, warm soft pink background, bright watercolor illustration, flat educational watercolor style, no text',
  'verguenza':        'a person with rosy flushed cheeks and eyes looking down and away, shoulders slightly hunched inward, small sheepish grimace, warm soft pink background, bright watercolor illustration, flat educational watercolor style, no text',
  'emocionado':       'a person with a wide enthusiastic grin, eyes lit up and sparkling, one fist raised in the air triumphantly, leaning forward with energy, vibrant warm orange-yellow background, bright watercolor illustration, flat educational watercolor style, no text',
  'emocionada':       'a person with a wide enthusiastic grin, eyes lit up and sparkling, one fist raised in the air triumphantly, leaning forward with energy, vibrant warm orange-yellow background, bright watercolor illustration, flat educational watercolor style, no text',
  'entusiasmado':     'a person with a wide enthusiastic grin, eyes lit up and sparkling, one fist raised in the air triumphantly, leaning forward with energy, vibrant warm orange-yellow background, bright watercolor illustration, flat educational watercolor style, no text',
  'orgulloso':        'a person standing tall with chest slightly out, a quiet confident smile, head held high, warm golden light behind them, bright watercolor illustration, flat educational watercolor style, no text',
  'orgullosa':        'a person standing tall with chest slightly out, a quiet confident smile, head held high, warm golden light behind them, bright watercolor illustration, flat educational watercolor style, no text',
  'alegre':           'a person with a wide genuine smile, eyes crinkled with joy, arms slightly raised and open, warm golden sunlit background, bright watercolor illustration, flat educational watercolor style, no text',
  // Cross-language emotion synonyms (route to same concept as Spanish originals)
  // French
  'triste':           'a person with a downturned mouth, glistening eyes, and a single tear on one cheek, slightly slumped shoulders, soft cool blue-gray background, bright watercolor illustration, flat educational watercolor style, no text',
  'heureux':          'a person with a wide genuine smile, eyes crinkled with joy, arms slightly raised and open, warm golden sunlit background, bright watercolor illustration, flat educational watercolor style, no text',
  'heureuse':         'a person with a wide genuine smile, eyes crinkled with joy, arms slightly raised and open, warm golden sunlit background, bright watercolor illustration, flat educational watercolor style, no text',
  'en colere':        'a person with deeply furrowed brows, clenched jaw, and arms tightly crossed, face slightly flushed, warm red-orange tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'nerveux':          'a person with wide anxious eyes and hunched shoulders, hands fidgeting together at chest, biting their lip, pale cool background, bright watercolor illustration, flat educational watercolor style, no text',
  'surpris':          'a person with eyebrows raised high, eyes wide open, mouth forming an O, both hands flying up near face, bright clean background, bright watercolor illustration, flat educational watercolor style, no text',
  'fatigue':          'a person mid-yawn with droopy heavy eyelids, one hand covering their mouth, soft deep-blue evening tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'ennuye':           'a person with heavy drooping eyelids and a flat expression, chin resting in one hand, slouched, muted gray-beige background, bright watercolor illustration, flat educational watercolor style, no text',
  'effraye':          'a person with wide frightened eyes, shoulders raised in a startled shrug, hands held up near chest, shadowy cool blue background, bright watercolor illustration, flat educational watercolor style, no text',
  'excite':           'a person with a wide enthusiastic grin, one fist raised triumphantly, leaning forward with energy, vibrant warm orange-yellow background, bright watercolor illustration, flat educational watercolor style, no text',
  // German
  'glucklich':        'a person with a wide genuine smile, eyes crinkled with joy, arms slightly raised and open, warm golden sunlit background, bright watercolor illustration, flat educational watercolor style, no text',
  'traurig':          'a person with a downturned mouth, glistening eyes, and a single tear on one cheek, slightly slumped shoulders, soft cool blue-gray background, bright watercolor illustration, flat educational watercolor style, no text',
  'wutend':           'a person with deeply furrowed brows, clenched jaw, and arms tightly crossed, face slightly flushed, warm red-orange tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'uberrascht':       'a person with eyebrows raised high, eyes wide open, mouth forming an O, both hands flying up near face, bright clean background, bright watercolor illustration, flat educational watercolor style, no text',
  'mude':             'a person mid-yawn with droopy heavy eyelids, one hand covering their mouth, soft deep-blue evening tones in background, bright watercolor illustration, flat educational watercolor style, no text',
  'gelangweilt':      'a person with heavy drooping eyelids and a flat expression, chin resting in one hand, slouched, muted gray-beige background, bright watercolor illustration, flat educational watercolor style, no text',
  'angstlich':        'a person with wide frightened eyes, shoulders raised, hands held up near chest, shadowy cool blue background, bright watercolor illustration, flat educational watercolor style, no text',
  'aufgeregt':        'a person with a wide enthusiastic grin, one fist raised triumphantly, leaning forward with energy, vibrant warm orange-yellow background, bright watercolor illustration, flat educational watercolor style, no text',
