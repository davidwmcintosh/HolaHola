...
export const CHARACTER_PROFILES = {
  ...
  ES: {
    primary:   'Daniela, a 28-year-old Latina woman with long wavy dark-brown hair, warm medium-brown skin, and bright brown eyes, wearing a sky-blue short-sleeve collared button-up shirt and dark jeans, drawn in soft watercolor children\'s book illustration style with clean fine ink outlines',
...
export const SCENE_OVERRIDES: Record<string, string> = {
  ...
  'como esta':          `${CHAR.ES.primary} greeting ${CHAR.ES.abuela} with a warm respectful smile and an open-hand gesture on a sunny sidewalk, ${CHAR.ES.abuela} smiling back with gentle warmth, a formal-but-affectionate exchange, cheerful watercolor illustration`,
