...
export const SCENE_OVERRIDES: Record<string, string> = {
  ...
  'como esta':          `${CHAR.ES.primary} greeting ${CHAR.ES.abuela} with a warm respectful smile and an open-hand gesture on a sunny sidewalk, ${CHAR.ES.abuela} smiling back with gentle warmth, a formal-but-affectionate exchange`,
