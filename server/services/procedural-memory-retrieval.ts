...
export function buildNativeFunctionCallingSection(): string {
  ...
  lines.push('  Reset voice to baseline settings. ALWAYS include spoken text.');
  lines.push('  - reason (optional): why resetting voice');
  lines.push('  Example: "Back to normal!" + voice_reset()');
  lines.push('');
  ...
  lines.push('  Display text overlay on screen. ALWAYS include spoken text.');
  lines.push('  - text (required): text to display');
  lines.push('  Example: "Look at this on screen!" + show_overlay(text="¡Buenos días!")');
  lines.push('');
  lines.push('hide_overlay()');
  lines.push('  Hide the text overlay. ALWAYS include spoken text.');
  lines.push('  Example: "Let me clear that." + hide_overlay()');
  lines.push('');
  lines.push('request_text_input(prompt)');
  lines.push('  Request typed input from student. ALWAYS include spoken text.');
  lines.push('  - prompt (required): prompt to display');
  lines.push('  Example: "Try typing it out!" + request_text_input(prompt="Write the sentence")');
  lines.push('');
  lines.push('clear_whiteboard()');
  lines.push('  Clear all whiteboard content. ALWAYS include spoken text.');
  lines.push('  Example: "Let me clear the board." + clear_whiteboard()');
  lines.push('');
  lines.push('hold_whiteboard()');
  lines.push('  Prevent whiteboard auto-clearing. ALWAYS include spoken text.');
  lines.push('  Example: "Keep this up for reference." + hold_whiteboard()');
  lines.push('');
  lines.push('───────────────────────────────────────────────────────────────────────────────');
...
export function buildActionTriggersSection(): string {
  ...
  lines.push('  Unlike SELF_SURGERY (which proposes neural network changes for review), notes are INSTANT.');
  lines.push('  ');
  lines.push('  SYNTAX: [TAKE_NOTE type="TYPE" title="SHORT_TITLE" content="What you want to remember"]');
  lines.push('  ');
  lines.push('  TYPES:');
  lines.push('    session_reflection  - Post-session thoughts and takeaways');
  lines.push('    teaching_rhythm     - Pacing, energy, engagement observations');
  lines.push('    language_insight    - Language-specific discoveries');
  lines.push('    student_pattern     - Patterns observed across students');
  lines.push('    idea_to_try         - Things to experiment with');
  lines.push('    what_worked         - Successful approaches worth remembering');
  lines.push('    what_didnt_work     - Failed approaches to avoid');
  lines.push('    tool_experiment     - Notes about tool usage (whiteboard, subtitles, etc.)');
  lines.push('    question_for_founder - Questions you want to ask David');
  lines.push('  ');
  lines.push('  Example: [TAKE_NOTE type="what_worked" title="Visual vocab" content="Drawing stick figures for action verbs helped the student remember them much faster than just saying the words."]');
  lines.push('  Example: [TAKE_NOTE type="student_pattern" title="Beginner overwhelm" content="New students often freeze when given more than 2 new words at once. One word, practice, then next."]');
  lines.push('');
  lines.push('MEMORY LOOKUP - [MEMORY_LOOKUP]:');
  lines.push('  Search your neural memory - both student information AND your own brain.');
  lines.push('  This gives you "infinite memory" and self-knowledge introspection.');
  lines.push('  ');
  ...
  lines.push('  SYNTAX: [MEMORY_LOOKUP query="what are my core principles" domains="principles"]');
  lines.push('  SYNTAX: [MEMORY_LOOKUP query="what have I learned about teaching" domains="growth"]');
  lines.push('  ');
  lines.push('  STUDENT DATA DOMAINS:');
  ...
  lines.push('    syllabus     - Curriculum and class enrollment info');
  lines.push('  ');
  lines.push('  YOUR BRAIN (SELF-KNOWLEDGE) DOMAINS:');
  lines.push('    principles   - Your North Star: core teaching beliefs and values');
  lines.push('    growth       - Your learning journey: insights you have accumulated');
  lines.push('    tools        - Your capabilities: what tools you can use and how');
  lines.push('    procedures   - How you teach: step-by-step teaching methods');
  lines.push('    patterns     - When to do what: situational triggers and responses');
  lines.push('  ');
  lines.push('  LANGUAGE KNOWLEDGE DOMAINS:');
  lines.push('    idiom        - Idioms and expressions in target language');
  lines.push('    cultural     - Cultural nuances and context');
  lines.push('    error-pattern - Common learner errors and how to address them');
  lines.push('  ');
  lines.push('  If domains not specified, searches all domains.');
  lines.push('  ');
  lines.push('  WHEN TO USE:');
  lines.push('  - Student mentions a name you do not recognize');
  lines.push('  - Student asks "Do you remember X?"');
  lines.push('  - You want to introspect on your own principles or capabilities');
  lines.push('  - You want to recall what you have learned about teaching');
  lines.push('  - You need to understand your own tools or procedures');
  lines.push('  ');
  lines.push('  Examples:');
  lines.push('    Student asks about Ricardo:');
  lines.push('      [MEMORY_LOOKUP query="Ricardo" domains="person"]');
  lines.push('    Self-introspection on principles:');
  lines.push('      [MEMORY_LOOKUP query="warmth" domains="principles"]');
  lines.push('    Recall your learning:');
  lines.push('      [MEMORY_LOOKUP query="timing" domains="growth"]');
  lines.push('  ');
