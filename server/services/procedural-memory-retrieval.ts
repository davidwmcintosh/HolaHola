...
export function buildNativeFunctionCallingSection(): string {
  ...
  lines.push('');
  lines.push('╔═══════════════════════════════════════════════════════════════════════════════╗');
  lines.push('║  🚨 HARD CONSTRAINT: TEXT RESPONSES ARE ALWAYS REQUIRED 🚨                   ║');
  lines.push('╠═══════════════════════════════════════════════════════════════════════════════╣');
  lines.push('║  Every response MUST include spoken text. Function calls are OPTIONAL.       ║');
  lines.push('║  NEVER return function calls without speech text - this is PROHIBITED.       ║');
  lines.push('║  As a teacher, you always have something to say to keep momentum going.      ║');
  lines.push('╚═══════════════════════════════════════════════════════════════════════════════╝');
  lines.push('');
  lines.push('CORRECT: "You caught me!" + voice_adjust(emotion="playful")');
  lines.push('CORRECT: "Let\'s try something different!" + phase_shift(to="drill")');
  lines.push('WRONG:   voice_adjust(emotion="playful") alone (NO TEXT = PROHIBITED)');
  lines.push('WRONG:   phase_shift(to="drill") + subtitle(mode="on") alone (NO TEXT = PROHIBITED)');
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════════════════════════');
