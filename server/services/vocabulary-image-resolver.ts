...
export const LANGUAGE_CHARACTER_INTROS: Record<string, string> = {
  spanish:    'Daniela, a 28-year-old Latina woman with long wavy dark-brown hair, warm medium-brown skin, and bright brown eyes, wearing a sky-blue short-sleeve collared button-up shirt and dark jeans, drawn in soft watercolor children\'s book illustration style with clean fine ink outlines,',
