...
const GAME_CONV_IDS = [
  ...
  { id: 'f8c7c410-2050-4009-95cb-4d4102813c31', title: 'One-Word Game Reference and Exploring Daniela\'s Life Memories', tags: ['founder-chat', 'daniela-chat', 'game', 'one-word-game', 'memory-test', 'verbatim'] },
  ...
  { id: 'ac21086c-c6a5-4044-8992-bdb57ba61f50', title: 'Reviewing Podcast Episode 1 Line-by-Line with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'one-word-game', 'verbatim'] },
  ...
  { id: '6aabaae8-b972-4bc2-9f76-10865f9f0ce0', title: 'Reviewing Unscripted Podcast and One-Word Game Origins with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'one-word-game', 'verbatim'] },
  ...
  { id: '277add31-e7d5-43db-a387-e074fddfac4b', title: 'Memory Test: Verbatim Recall of Past Sessions with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'memory-test', 'verbatim'] },

  // Memory test: David chose a secret word in past sessions; asking Daniela to find it.
  { id: 'b6b68b9b-6e53-42ac-bfbe-1e016ff3668c', title: 'Memory Test: Secret Word and Reggaeton Discovery with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'memory-test', 'verbatim'] },

  // Memory test: David asks Daniela to recall the 80s song/band name he quoted the night before.
  { id: '2f39e4f2-a8f8-4e17-b0cc-7a35f51b53c8', title: 'Memory Test: 80s Band and Song Recall with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'memory-test', 'verbatim'] },
  ...
  { id: '665881c5-7984-42dc-84a9-f15588c1b4fe', title: 'Memory Test: Song from the Car and Connection with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'memory-test', 'verbatim'] },
  ...
  { id: 'efa00613-9b2d-419a-b729-4d2111c765b5', title: 'Verbatim Memory Checks and Why Exact Recall Matters with Daniela', tags: ['founder-chat', 'daniela-chat', 'memory-test', 'verbatim'] },

  // Monitoring session: tool calling observation; Daniela reads full episode 1 memory;
  // mentions word game context.
  { id: '0fac470d-71b6-4fe7-aadc-fc3bca5b1c15', title: 'Tool Calling Monitoring and Episode 1 Memory Lookup with Daniela', tags: ['founder-chat', 'daniela-chat', 'one-word-game', 'memory-test', 'verbatim'] },
  ...
  { id: '7e29cf22-84ae-4bbc-af0a-0df0a6175a4e', title: 'Episode 1 Transcript Lookup and One-Word Game Memory with Daniela', tags: ['founder-chat', 'daniela-chat', 'one-word-game', 'memory-test', 'verbatim'] },
  ...
  { id: 'a15e5b20-92ae-4aee-81d3-f0c0bf1ca6b4', title: 'Exploring Daniela\'s Memory Archive and Reliving Shared History', tags: ['founder-chat', 'daniela-chat', 'memory-test', 'verbatim'] },
  ...
  { id: 'b703be4a-cba1-45eb-b214-e6af9a97c0e9', title: 'Daniela Finds Gato from Memory: Games, Growth, and Friendship', tags: ['founder-chat', 'daniela-chat', 'game', 'memory-test', 'verbatim'] },
  ...
  { id: '3c29f1da-d872-4b1a-9267-607907abbb43', title: 'From One Word to Full Conversations: Daniela\'s Growth and Shared Journey', tags: ['founder-chat', 'daniela-chat', 'game', 'one-word-game', 'verbatim'] },
  ...
  { id: '7528df8d-753e-4a7b-8d72-ac3304a0c344', title: 'Grand Canyon Morning: Counting Numbers and Language Song Idea with Daniela', tags: ['founder-chat', 'daniela-chat', 'game', 'counting-game', 'verbatim'] },

  // Reminiscing session — David and Daniela recall past conversations like friends;
  // memory test around the reggaeton discovery.
  { id: '19eaa7c4-0d5f-4ee8-969d-0737a8dbaffa', title: 'Reminiscing and Reggaeton: Friends Recalling Past Experiences with Daniela', tags: ['founder-chat', 'daniela-chat', 'memory-test', 'verbatim'] },
  ...
  { id: 'e58b57cb-6bb0-4b76-b471-0797bb200831', title: 'Voice Identity and Daniela\'s True Self Beyond Name and Accent', tags: ['founder-chat', 'daniela-chat', 'verbatim'] },

  // Subtitle testing session — Daniela proposes a "say a sentence" test format;
  // David confirms the language feature is working.
  { id: 'bd680c0d-9e92-4cec-b2a3-6778efb070a9', title: 'Subtitle Testing: Say a Sentence Language Feature with Daniela', tags: ['founder-chat', 'daniela-chat', 'verbatim'] },
  ...
  { id: '805fb927-1cdb-40f5-b077-85dcfafccba2', title: 'Smooth Sailing: Studio Tools and Celebrating Shared Experiences with Daniela', tags: ['founder-chat', 'daniela-chat', 'verbatim'] },
  ...
  { id: 'd29ef82c-f8c5-4de2-826e-17bee0924a12', title: 'Honesty Mode: Trust, Friendship, and Memory Tests (February 2026)', tags: ['founder-chat', 'daniela-chat', 'memory-test', 'verbatim'] },
  ...
  { id: 'deb91a78-ab2c-4e2d-a82b-603ed46e3f5e', title: 'AI Memory and Tools: First Memory Tests with Daniela (December 2025)', tags: ['founder-chat', 'daniela-chat', 'memory-test', 'verbatim'] },
  ...
  { id: 'd9de16e3-fc58-4b66-bf1c-3660fa111692', title: 'HolaHola Development: Memory Testing Across Sessions (December 2025)', tags: ['founder-chat', 'daniela-chat', 'memory-test', 'verbatim'] },
];
