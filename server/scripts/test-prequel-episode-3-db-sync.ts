/**
 * test-prequel-episode-3-db-sync.ts
 *
 * CI check: confirms that docs/prequel-episode-3.md and the DB record
...
async function main() {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  sep();
  console.log(B('PART 1 — Read docs/prequel-episode-3.md'));
  sep();
  ...
  if (failed === 0) {
    ...
    console.log(G('   docs/prequel-episode-3.md and DB record cd66b19d are in sync.\n'));
    process.exit(0);
  } else {
