...
only while that utterance remains the active student turn. When newer student
speech begins, discard queued older grounding rather than merging it into the
...
response answers the current question.